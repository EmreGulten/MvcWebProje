...
namespace MvcWebProje.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Telefon,Fax,Whatsapp,Facebook,Tiwitter,Instagram")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Telefon,Fax,Whatsapp,Facebook,Tiwitter,Instagram")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
